...
document.addEventListener('DOMContentLoaded', async () => {
    ...
    await customElements.whenDefined('image-editor');
    ...
    console.log('Calling setImage:', { name, path, title });

    console.log(EventBus)
    if (typeof imageEditor.setImage === 'function') {
        imageEditor.setImage(name, path, title);
    } else {
        console.warn('setImage() is not available on imageEditor', imageEditor);
    }

    if (typeof imageEditor.setConfiguration === 'function') {
        console.log('setting configuration');
        imageEditor.setConfiguration({debug: true});
        console.log(imageEditor.configuration);

    } else {
        console.warn('setConfiguration() is not available on imageEditor', imageEditor);
    }
